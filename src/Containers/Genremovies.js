...
class Genremovies extends Component {
    ...
    componentDidUpdate() {
        ...
        if(this.props.genre.slice(0,10)==='Similar to') {
    ...
    render() {
        return(
            <div>
                ...
                />
                {/* <Hscroll> */}
                {(this.state.movies==="Please rate the movies as per your interest to start seeing the movies recommended by our system"||
